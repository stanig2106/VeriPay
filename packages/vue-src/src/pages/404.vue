...
onMounted(() => {
  ...
  document.addEventListener('mousemove', (event) => {
    ...
    const ghostEyes = document.querySelector('.box__ghost-eyes') as HTMLDivElement;
...
<template>
  <div class="box">
    ...
    <div class="box__description">
      ...
      <a class="box__button" @click="router.replace('/')" href="javascript:// Go back to home">Go back</a>
...
.box {
  ...
  .box__ghost {
    ...
    .box__ghost-shadow {
      height: 20px;
      box-shadow: 0 50px 15px 5px #5f551d;
      border-radius: 50%;
      margin: 0 auto;
